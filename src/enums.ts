/**
 * Enumeration types for Gaurabda Calendar
 */

export enum MahadvadasiType {
  EV_NULL = 0x100,
  EV_SUDDHA = 0x101,
  EV_UNMILANI = 0x102,
  EV_VYANJULI = 0x103,
...
export const FastTypeText: Record<FastType, string> = {
  [FastType.FAST_NULL]: 'No fasting',
  [FastType.FAST_NOON]: 'Fast till noon',
  [FastType.FAST_SUNSET]: 'Fast till sunset',
  [FastType.FAST_MOONRISE]: 'Fast till moonrise',
  [FastType.FAST_DUSK]: 'Fast till dusk',
  [FastType.FAST_MIDNIGHT]: 'Fast till midnight',
  [FastType.FAST_EKADASI]: 'Ekadasi fasting',
  [FastType.FAST_DAY]: 'Fast today',
  [FastType.FAST_END_TITHI]: 'Fast till end of tithi',
  [FastType.FAST_END_NAKSATRA]: 'Fast till end of naksatra',
  [FastType.FAST_END_TAN]: 'Fast till end of tithi and naksatra',
  [FastType.FAST_END_TON]: 'Fast till end of tithi or naksatra',
};

export enum FeastType {
  FEAST_NULL = 0,
  FEAST_TODAY_FAST_YESTERDAY = 1,
  FEAST_TOMORROW_FAST_TODAY = 2,
}

export enum SpecialFestivalId {
  SPEC_RETURNRATHA = 3,
  SPEC_HERAPANCAMI = 4,
...
export const GC_LAYOUT_DATA: GCLayoutData = {
  textSizeH1: 36,
  textSizeH2: 32,
  textSizeText: 24,
  textSizeNote: 16,
...
export type PeriodUnitValue = (typeof PeriodUnit)[keyof typeof PeriodUnit];
